...
1. **[ワークスペース名]** - グローバルに一意の任意の名前を選択します。 この演習では、**myworkspace** を使用します。
...
5. **[Azure Data Lake Storage Gen2]** カテゴリの下に、**myworkspace ( プライマリ - contosolake )** のような名前の項目を展開します。
...
2. **[Azure Data Lake Storage Gen2]**>**[myworkspace (Primary - contosolake)]** に移動します。
